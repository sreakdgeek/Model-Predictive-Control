...
vector<double> MPC::Solve(Eigen::VectorXd x0, Eigen::VectorXd coeffs) {
  ...
  std::cout << "DEBUG: Started the solver..." << std::endl;
  ...
  std::cout << "DEBUG: After initializing variables and constraints of the solver..." << std::endl;
  ...
  std::cout << "DEBUG: Before finding the solution..." << std::endl;
  ...
  std::cout << "DEBUG: After finding the solution..." << std::endl;
  ...
  std::cout << "DEBUG: Found the solution. " << std::endl;
